...
public class initSQL {
    ...
    static Connection con = null, con_new = null;
    public static Statement stmt = null, stmt_new = null;
    ResultSet resultSet = null;

    public static void connectSQL() {
        try {
            logger.logApp.info("Establishing MySQL connection to dbnav...");
            ...
            logger.logApp.info("GameNav old games database selected.");
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            logger.logApp.info("Establishing MySQL connection to gamenav_appdata...");
            con_new = DriverManager.getConnection(env.get("SERVER_URL"),env.get("SERVER_USER"),env.get("SERVER_PW"));
            logger.logApp.info("Established MySQL connection.");
            stmt = con.createStatement();
            stmt.executeUpdate("use gn_games");
            logger.logApp.info("GameNav new games database selected.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
